...
{
    public class LuaJitFunctionBO6 : LuaJitFunction
    {
        public override ILuaJitOpCodeTable OpCodeTable => new LuaJitOpCodeTableBO6();
        public LuaJitFunctionBO6(ILuaFile luaFile, BinaryReader reader) : base(luaFile, reader)
        {
        }
